...
from pipelines.datalake.extract_load.osinfo_web.tasks import (
    download_from_osinfo,
    transform_data,
)
...
with Flow(
    ...
    raw_files = download_from_osinfo(endpoint="despesa", destination_folder=local_folders["raw"])
