...
class TestExtrairItemEscalas(unittest.TestCase):
    @patch("pipelines.datalake.extract_load.sisreg.nucleo.extractors.escalas.requisicao_educada")
    def test_parseia_csv_fixture(self, mock_req) -> None:
        from pipelines.datalake.extract_load.sisreg.nucleo.extractors.escalas import (
...
class TestRegistroNoRegistry(unittest.TestCase):
    def test_extrator_registrado(self) -> None:
        from pipelines.datalake.extract_load.sisreg.nucleo.extractors import (  # noqa: F401
            escalas,
        )
        from pipelines.datalake.extract_load.sisreg.nucleo.extractors.escalas import (
            extrair_item_escalas,
        ...
        from pipelines.datalake.extract_load.sisreg.nucleo.registry import CONJUNTOS
