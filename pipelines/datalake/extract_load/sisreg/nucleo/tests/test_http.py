# -*- coding: utf-8 -*-
"""
Testes da camada HTTP educada (http.py).
...
from pipelines.datalake.extract_load.sisreg.nucleo.http import (
    detectar_bloqueio,
    requisicao_educada,
)
...
class TestRequisicaoEducada(unittest.TestCase):
    ...
    @patch("pipelines.datalake.extract_load.sisreg.nucleo.http._dormir_com_jitter")
