...
class TestObterUnidades(unittest.TestCase):
    @patch("pipelines.datalake.extract_load.sisreg.nucleo.extractors.preparos.requisicao_educada")
    def test_extrai_unidades_da_fixture(self, mock_req) -> None:
        from pipelines.datalake.extract_load.sisreg.nucleo.extractors.preparos import (
            _obter_unidades,
        )
...
class TestExtrairItemPreparosSharding(unittest.TestCase):
    @patch("pipelines.datalake.extract_load.sisreg.nucleo.extractors.preparos._obter_procedimentos")
    @patch("pipelines.datalake.extract_load.sisreg.nucleo.extractors.preparos._obter_unidades")
