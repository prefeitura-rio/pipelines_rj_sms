...
from pipelines.datalake.extract_load.sisreg.nucleo.errors import ErroBloqueio
...
class TestGerarRoteiro(unittest.TestCase):
    def test_roteiro_contem_todas_as_combinacoes(self) -> None:
        ...
        from pipelines.datalake.extract_load.sisreg.nucleo.extractors.solicitacoes import (
            _gerar_roteiro,
        )
...
class TestExtrairItemSolicitacoes(unittest.TestCase):
    @patch(
        ...
        ".solicitacoes.requisicao_com_reauth"
    )
