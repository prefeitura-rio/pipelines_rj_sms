...
Foco: gate de completude, consolidacao e normalizacao.
...
from pipelines.datalake.extract_load.sisreg.nucleo.resultado import (
    Consolidado,
    ResultadoConjunto,
)
...
class TestPlanejarTrabalho(unittest.TestCase):
    """Testa a delegacao ao planejador do conjunto."""
