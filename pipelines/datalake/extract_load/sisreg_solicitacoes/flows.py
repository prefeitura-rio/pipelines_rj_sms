...
from pipelines.datalake.extract_load.sisreg_solicitacoes.tasks import (
...
from pipelines.datalake.extract_load.sisreg_solicitacoes.schedules import schedule
