...
TABELAS_CONFIG = [
    ...
    ("altas_arquivos", "subpav_altas_referenciadas", "daily", {"id_column": "id_alta_arquivo"}),
    ("altas_medicamentos", "subpav_altas_referenciadas", "daily", {"id_column": "id_alta_medicamento"}),
    ("altas_pendentes", "subpav_altas_referenciadas", "daily", {"id_column": "id_alta_pendente"}),
    ("altas_pendentes_referenciadas", "subpav_altas_referenciadas", "daily", {"id_column": "id_alta_pendente_referenciada"}),
    ("apgars", "subpav_altas_referenciadas", "monthly", {"id_column": "id_apgar"}),
    ("comorbidades", "subpav_altas_referenciadas", "monthly", {"id_column": "id_comorbidade"}),
    ("dashboard", "subpav_altas_referenciadas", "monthly", {"id_column": "visualizacao"}),
    ("dashboard_feedback", "subpav_altas_referenciadas", "monthly"),
    ("desfechos_gestacao", "subpav_altas_referenciadas", "monthly", {"id_column": "id_desfecho_gestacao"}),
    ("desfechos_internacao", "subpav_altas_referenciadas", "monthly", {"id_column": "id_desfecho_internacao"}),
    ...
    ("feridas_cirurgicas", "subpav_altas_referenciadas", "monthly", {"id_column": "id_ferida_cirurgica"}),
    ...
    ("formularios_exames", "subpav_altas_referenciadas", "monthly", {"id_column": "id_formulario_exame"}),
    ("formularios_motivos_internacao", "subpav_altas_referenciadas", "monthly", {"id_column": "id_formulario_motivo_internacao"}),
    ("gestantes", "subpav_altas_referenciadas", "daily", {"id_column": "id_gestante"}),
    ("gestantes_patologias", "subpav_altas_referenciadas", "daily", {"id_column": "id_gestante_patologia"}),
    ...
    ("gestantes_uti_hemoderivados", "subpav_altas_referenciadas", "daily", {"id_column": "id_gestante_uti_hemoderivado"}),
    ("gestantes_uti_hemorragias", "subpav_altas_referenciadas", "daily", {"id_column": "id_gestante_uti_hemorragia"}),
    ("gestantes_uti_ventilatorios", "subpav_altas_referenciadas", "daily", {"id_column": "id_gestante_uti_ventilatorio"}),
    ("hemoderivados", "subpav_altas_referenciadas", "monthly", {"id_column": "id_hemoderivado"}),
    ("histerectomia_causas", "subpav_altas_referenciadas", "monthly", {"id_column": "id_histerectomia_causa"}),
    ("histerectomia_tipos", "subpav_altas_referenciadas", "monthly", {"id_column": "id_histerectomia_tipo"}),
    ("hemoderivados", "subpav_altas_referenciadas", "monthly", {"id_column": "id_hemoderivado"}),
    ("historico_edicao", "subpav_altas_referenciadas", "daily", {"id_column": "id_historico_edicao"}),
    ("intercorrencias", "subpav_altas_referenciadas", "monthly", {"id_column": "id_intercorrencia"}),
    ("internacoes", "subpav_altas_referenciadas", "daily", {"id_column": "id_internacao"}),
    ("internacoes_comorbidades", "subpav_altas_referenciadas", "daily", {"id_column": "id_internacao_comorbidade"}),
    ("internacoes_diagnosticos", "subpav_altas_referenciadas", "daily", {"id_column": "id_internacao_diagnostico"}),
    ("internacoes_exames", "subpav_altas_referenciadas", "daily", {"id_column": "id_internacao_exame"}),
    ("internacoes_intercorrencias", "subpav_altas_referenciadas", "daily", {"id_column": "id_internacao_intercorrencia"}),
    ...
    ("motivos_clinicos", "subpav_altas_referenciadas", "monthly", {"id_column": "id_motivo_clinico"}),
    ("motivos_internacao", "subpav_altas_referenciadas", "monthly", {"id_column": "id_motivo_internacao"}),
    ("pacientes", "subpav_altas_referenciadas", "daily", {"id_column": "id_paciente"}),
    ("patologias_gestantes", "subpav_altas_referenciadas", "monthly", {"id_column": "id_patologia_gestante"}),
    ("protocolos_hemorragia", "subpav_altas_referenciadas", "monthly", {"id_column": "id_protocolo_hemorragia"}),
    ("racas_cores", "subpav_altas_referenciadas", "monthly", {"id_column": "id_raca_cor"}),
    ("rn_intercorrencias", "subpav_altas_referenciadas", "daily", {"id_column": "id_rn_intercorrencia"}),
    ("sulfato_magnesio", "subpav_altas_referenciadas", "monthly", {"id_column": "id_sulfato_magnesio"}),
    ("suportes_ventilatorios", "subpav_altas_referenciadas", "monthly", {"id_column": "id_suporte_ventilatorio"}),
    ...
    ("agendamento_profissional", "subpav_cegonha", "monthly", {"id_column": "id_agendamento_profissional"}),
    ...
    ("dados_maternidade_gestantes", "subpav_cegonha", "daily", {"id_column": "id_dados_maternidade_gestante"}),
    ...
    ("maternidade_tipo_gestantes", "subpav_cegonha", "monthly", {"id_column": "id_maternidade_tipos_gestante"}),
