...
from pipelines.datalake.extract_load.vitacare_backup_mensal_sqlserver.schedules import vitacare_backup_manager_schedule 
...
with Flow("DataLake - Vitacare Historic - CNES Operator") as flow_vitacare_historic_operator:
    ...
    bq_table_ids = build_bq_table_name.map(
        table_name=tables_for_this_cnes 
    )
