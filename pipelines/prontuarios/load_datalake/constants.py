...
class constants(Enum):
    ...
    ENDPOINT_REQUIRED_FIELDS = {
        ...
        "mrg/teams": ["id_ine", "nome_referencia", "id_cnes", "id_equipe_tipo",
                      "equipe_tipo_descricao", "id_area", "area_descricao",
                      "ultima_atualizacao_profissionais","ultima_atualizacao_infos_equipe"]
    }
